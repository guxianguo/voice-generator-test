"选择截图区域"
"""
https://blog.csdn.net/frostime/article/details/104798861
"""
__author__ = 'Frostime'
...
class ScreenShot():
    ...
    def captureImage(self):
        if self.area.empty():
            ...
            global box1,box2
            #print("?",self.area.area_box.box(),"?",screen_scale_rate)
            box_area = [x * screen_scale_rate for x in self.area.area_box.box()]
            box1 = self.area.area_box.box()
            box2 = box_area
            self.clear()
...
def main():
    print("real_resolution:",real_resolution,"screen_size:",screen_size,"screen_scale_rate:",screen_scale_rate)
...
if __name__ == '__main__':
    main()
    # p = ImageGrab.grab([0,0,1200,1000])
    # p.show()
